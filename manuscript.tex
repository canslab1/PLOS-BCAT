...
% ---------------------------------------------------------------
% Preview mode toggle (controls Figures only; Algorithms 1-3 always inline):
...
% Note: Algorithms 1-3 (alg*.png) are always rendered inline because they
%       are not separately uploaded as Figure files.
% ---------------------------------------------------------------
\newif\ifpreview
\previewfalse  % <-- set \previewtrue for local preview; OFF (\previewfalse) for Editorial Manager submission

\graphicspath{{figures/}}  % needed for algorithm images (and figures when preview is on)
...
% Corresponding author indication using PLOS template standard format
% with explicit "Corresponding author" text so automated tools recognize
% this as an author-affiliation line rather than a free-standing note.
\textsuperscript{*}Corresponding author. E-mail: swwang@nkust.edu.tw
